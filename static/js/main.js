    ...
    function displayResult(data) {
        ...
        detailsHTML += `
            <div class="detail-item">
                <div class="detail-label">Тип Хеша</div>
        ...
        detailsHTML += `
            <div class="detail-item">
                ...
                <div class="detail-value">${escapeHtml(data.desc)}</div>
            </div>
        `;
        ...
        detailsHTML += `
            <div class="detail-item">
                ...
                <div class="detail-value">${escapeHtml(data.length.toString())} символов</div>
            </div>
        `;
        
        detailsHTML += `
            <div class="detail-item">
                <div class="detail-label">Режим Hashcat</div>
